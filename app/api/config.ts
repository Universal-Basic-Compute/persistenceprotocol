...
export const AVAILABLE_MODELS = [
  ...
  { id: 'o4-mini-2025-04-16', name: 'GPT-4o Mini', description: 'Fast responses', selected: true },
  { id: 'gpt-4.1-2025-04-14', name: 'GPT-4.1', description: 'OpenAI\'s latest model', selected: true },
